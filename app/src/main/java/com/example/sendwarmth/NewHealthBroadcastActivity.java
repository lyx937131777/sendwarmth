...
public class NewHealthBroadcastActivity extends AppCompatActivity implements DateAndTimePickerDialog.DateAndTimePickerDialogInterface {
    ...
    private NewHealthBroadcastPresenter newHealthBroadcastPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_new_health_broadcast);
        ...
        newHealthBroadcastPresenter = myComponent.newHealthBroadcastPresenter();

        titleText = findViewById(R.id.theme_edit);
        expireTimeText = findViewById(R.id.expire_time);
    ...
    private void initDateAndTimePickerDalog() {
        ...
        expireTime = 0;
        expireTimeText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dateAndTimePickerDialog.showDateAndTimePickerDialog(1,expireTime);
            }
        });
    }
    ...
    private void initDialog()
    {
        ...
        dialogCameraBotton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                if (ContextCompat.checkSelfPermission(NewHealthBroadcastActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(NewHealthBroadcastActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, TAKE_PHOTO);
                } else {
                    takePhoto();
                }
                dialog.cancel();
        ...
        dialogAlbumBotton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                if (ContextCompat.checkSelfPermission(NewHealthBroadcastActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(NewHealthBroadcastActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, CHOOSE_PHOTO);
                } else {
                    openAlbum();
                }
                dialog.cancel();
    ...
    private void takePhoto(){
        ...
        {
            imageUri = FileProvider.getUriForFile(NewHealthBroadcastActivity.this,
...
//            imageView.setImageBitmap(bitmap);
    ...
    public void positiveListener() {
        ...
        expireTimeText.setText(TimeUtil.dateToString(calendar.getTime(),"yyyy-MM-dd"));
