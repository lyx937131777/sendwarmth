...
public class WXPayEntryActivity extends AppCompatActivity implements IWXAPIEventHandler {
    ...
    private static final int DEFAULT_RESULT_CODE = 100;
    private static int resultCode = DEFAULT_RESULT_CODE;
    ...
    private static class MyHandler extends Handler {
        ...
        public MyHandler(WXPayEntryActivity wxPayEntryActivity){
            wxEntryActivityWeakReference = new WeakReference<WXPayEntryActivity>(wxPayEntryActivity);
        }
